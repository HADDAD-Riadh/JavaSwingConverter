...
public class ActionSmc extends JFrame {
	...
	private JComboBox getJComboBox0()
	{
		...
		if (jComboBox0 == null)
		{
			...
			{
				dd.add(staticClassSmc.actionStatic._SmcConcepts.get(i).getUri().substring(staticClassSmc.actionStatic._SmcConcepts.get(i).getUri().indexOf("#") + 1));
			}
